			...
			<div class="rounded p-5 mb-3">
				...
				<div class="row">
					...
					<form method="POST" action="<?php Util::display($_SERVER['PHP_SELF']); ?>">
						...
						<div class="col-12 clearfix p-1">
							<input type="text" class="form-control form-control-sm" placeholder="user" name="username" required>
						</div>
						
						<div class="col-12 clearfix p-1">
							<input type="password" class="form-control form-control-sm" placeholder="pass" name="password" required>
						</div>
						...
						<div class="col-12 clearfix p-1">
						<a class="btn btn-outline-primary btn-block" href="<?= SUB_DIR ?>/register.php">register</a>
